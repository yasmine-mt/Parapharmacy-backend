...
namespace backend.Repositories
{
    public class OrderItemRepository : IListRepository<OrderItem>
    {
        ...
        {
            string query = @"SELECT OrderItemID, Quantity, OrderID, ProductSizeID FROM dbo.OrderItems";
        ...
        {
            string query = @"SELECT * FROM dbo.OrderItems WHERE OrderID = @OrderID";
        ...
        {
            string query = @"INSERT INTO dbo.OrderItems 
        ...
        {
            string query = @"UPDATE dbo.OrderItems
        ...
        {
            string query = @"DELETE FROM dbo.OrderItems WHERE OrderItemID = @OrderItemID";
